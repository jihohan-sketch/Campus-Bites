...
const MENUS: Record<string, DayMenu> = {
  ...
  // 9월 1주차
  '20260907': {
    breakfast: ['영양죽', '삶은달걀', '바나나', '셀프토스트 & 잼 & 버터', '시리얼 & 우유'],
    lunch: ['백미밥', '소고기미역국', '매운갈비찜', '동그랑땡전', '오이무침', '포기김치'],
    dinner: ['백미밥', '유부주머니국', '크림감자뇨끼', '채소 & 요거트소스', '포기김치'],
  },
  '20260908': {
    breakfast: ['뉴욕핫도그', '베이컨스크램블에그', '떠먹는 요거트', '시리얼 & 우유'],
    lunch: ['잡곡밥', '조랭이떡국', '오삼볶음', '옥수수전', '숙주미나리무침', '포기김치'],
    dinner: ['백미밥', '소고기뭇국', '분모자순살찜', '라이스찹고구마볼', '포기김치'],
  },
  '20260909': {
    breakfast: ['소고기미역죽', '베이컨 & 크림치즈', '삶은달걀', '시리얼 & 우유'],
    lunch: ['후리가케밥', '명란크림우동', '치킨또띠아', '떠먹는 요거트', '피클 & 할라피뇨'],
    dinner: ['백미밥', '어묵국', '파채자돌떡볶이', '김말이 & 만두튀김', '포기김치'],
  },
  '20260910': {
    breakfast: ['계란국', '베이컨소시지볶음', '셀프토스트 & 잼 & 버터', '시리얼 & 우유'],
    lunch: ['잡곡밥', '감자짜글이', '소불고기', '동두부구이 & 양념장', '새콤무침', '포기김치'],
    dinner: ['잡곡밥', '사골순대국 & 다대기', '삼치카레구이', '메추리알조림', '깍두기'],
  },
  '20260911': {
    breakfast: ['셀프햄버거', '연유주스', '바나나', '시리얼 & 우유'],
    lunch: [
      '백미밥',
      '얼큰콩나물국',
      '바몬드커리라이스',
  ...
  '20260914': {
    breakfast: ['영양죽', '삶은달걀', '바나나', '셀프토스트 & 잼 & 버터', '시리얼 & 우유'],
    lunch: ['백미밥', '김치어묵국수', '바싹돈육불고기', '메밀전병', '오이양배추무침', '요구르트'],
    dinner: ['잡곡밥', '콩나물국', '치즈닭갈비', '해쉬브라운 & 케첩', '포기김치'],
  },
  '20260915': {
    breakfast: ['뉴욕핫도그', '베이컨스크램블에그', '떠먹는 요거트', '시리얼 & 우유'],
    lunch: [
    ...
    dinner: ['중화풍 계란볶음밥', '마라탕', '꿔바로우', '가마보꼬어묵조림', '포기김치'],
  },
  '20260916': {
    breakfast: [
      '소고기미역죽',
    ...
    dinner: ['백미밥', '모듬찌개 & 라면사리', '제육볶음', '미니핫도그 & 케첩', '포기김치'],
  },
  '20260917': {
    breakfast: ['불고기덮밥', '우동국', '무피클', '프렌치토스트', '시리얼 & 우유'],
    lunch: [
    ...
    dinner: ['백미밥', '순살감자탕', '오징어김치전', '생선까스 & 양파드레싱', '포기김치'],
  },
  '20260918': {
    breakfast: ['셀프햄버거', '연유주스', '바나나', '시리얼 & 우유'],
    lunch: ['잡곡밥', '순두부국', '돈사태떡찜', '고구마치즈스틱', '도토리묵무침', '포기김치'],
    // 금요일 저녁은 급식 없음.
  },
};
